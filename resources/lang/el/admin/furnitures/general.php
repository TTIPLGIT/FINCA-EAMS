...
return array(
    'about_furnitures_title' 			=> 'Σχετικά με τα αξεσουάρ',
    'about_furnitures_text'  			=> 'Τα αξεσουάρ είναι οτιδήποτε εκδίδετε στους χρήστες αλλά δεν έχουν αύξοντα αριθμό (ή δεν σας ενδιαφέρει να τα εντοπίζετε μοναδικά). Για παράδειγμα, ποντίκια υπολογιστή ή πληκτρολόγια.',
    'furnitures_category' 				=> 'Κατηγορία αξεσουάρ',
    'furnitures_name'  					=> 'Όνομα ανταλλακτικού',
