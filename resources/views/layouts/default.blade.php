          ...
          <!-- Navbar Right Menu -->
            <div class="navbar-custom-menu">
              <ul class="nav navbar-nav">
                  ...
                  @endcan
                  @can('index', \App\Models\Electronics::class)
                  <li {!! (Request::is('electronics*') ? ' class="active"' : '') !!}>
                      <a href="{{ route('electronics.index') }}">
                          <i class="fa fa-microchip"></i>
                      </a>
                  </li>
                  @endcan
                  @can('index', \App\Models\Furnitures::class)
                  <li {!! (Request::is('furnitures*') ? ' class="active"' : '') !!}>
                      <a href="{{ route('furnitures.index') }}">
                          <i class="fa fa-desktop"></i>
                      </a>
                  </li>
                  @endcan
                   @can('index', \App\Models\Buildings::class)
                   ...
                   <ul class="dropdown-menu">
                     @can('create', \App\Models\Asset::class)
                      <li {!! (Request::is('hardware/create') ? 'class="active>"' : '') !!}>
                       ...
                       <li {!! (Request::is('electronics/create') ? 'class="active"' : '') !!}>
                           <a href="{{ route('electronics.create') }}">
                               <i class="fa fa-microchip"></i>
                               {{ trans('general.electronics') }}</a>
                       </li>
                       @endcan
                       @can('create', \App\Models\Furnitures::class)
                       <li {!! (Request::is('furnitures/create') ? 'class="active"' : '') !!}>
                           <a href="{{ route('furnitures.create') }}">
                               <i class="fa fa-tint fa-fw"></i>
                               {{ trans('general.furnitures') }}</a>
                       </li>
                       @endcan
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview{{ (Request::is('hardware*') ? ' active' : '') }}">
              ...
              <li{!! (Request::is('electronics*') ? ' class="active"' : '') !!}>
                <a href="{{ route('electronics.index') }}">
                  <i class="fa fa-microchip"></i>
                  <span>{{ trans('general.electronics') }}</span>
                </a>
              </li>
              @endcan
              @can('index', \App\Models\Furnitures::class)
              <li{!! (Request::is('furnitures*') ? ' class="active"' : '') !!}>
                <a href="{{ route('furnitures.index') }}">
                  ...
                  <span>{{ trans('general.furnitures') }}</span>
                </a>
              </li>
              @endcan
              @can('index', \App\Models\Buildings::class)
            <li class="treeview{{ (Request::is('buildings*') ? ' active' : '') }}">
                <a href="#"><i class="fa fa-building-o"></i>
                  <span>{{ trans('general.infrastructures') }}</span>
                  <i class="fa fa-angle-left pull-right"></i>
                </a>
                <ul class="treeview-menu">
                  <li>
            ...
            <li class="treeview{{ (Request::is('reports*') ? ' active' : '') }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li>
                        <a href="{{ url('reports/electronics') }}" {{ (Request::is('reports/electronics') ? ' class="active"' : '') }}>
                            {{ trans('general.electronics_report') }}
                        </a>
                    </li>
                     <li>
                        <a href="{{ url('reports/furnitures') }}" {{ (Request::is('reports/furnitures') ? ' class="active"' : '') }}>
                            {{ trans('general.furnitures_report') }}
                        </a>
                    </li>
                     <li>
                        <a href="{{ url('reports/buildings') }}" {{ (Request::is('reports/buildings') ? ' class="active"' : '') }}>
                            {{ trans('general.buildings_report') }}
                        </a>
                    </li>
                    <li>
