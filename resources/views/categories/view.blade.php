      ...
      <div class="box-body">
        ...
        <table
                ...
                @elseif ($category->category_type=='accessory')
                  ...
                  data-cookie-id-table="categoryElectronicsTable"
                  id="categoryElectronicsTable"
                  data-id-table="categoryElectronicsTable"
                  data-export-options='{
                      "fileName": "export-{{ str_slug($category->name) }}-electronics-{{ date('Y-m-d') }}",
                      "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                      }'
                      @elseif ($category->category_type=='infrastructures')
                  data-columns="{{ \App\Presenters\InfrastructuresPresenter::dataTableLayout() }}"
                  data-cookie-id-table="categoryInfrastructuresTable"
                  id="categoryInfrastructuresTable"
                  data-id-table="categoryInfrastructuresTable"
                  data-export-options='{
                      "fileName": "export-{{ str_slug($category->name) }}-electronics-{{ date('Y-m-d') }}",
                      "ignoreColumn": ["actions","image","change","checkbox","checkincheckout","icon"]
                      }'
