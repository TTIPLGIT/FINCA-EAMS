...
-- Dumping data for table asset_mgmt.accessories: ~6 rows (approximately)
/*!40000 ALTER TABLE `accessories` DISABLE KEYS */;
REPLACE INTO `accessories` (`id`, `name`, `category_id`, `user_id`, `qty`, `requestable`, `created_at`, `updated_at`, `deleted_at`, `location_id`, `purchase_date`, `purchase_cost`, `order_number`, `company_id`, `min_amt`, `manufacturer_id`, `model_number`, `supplier_id`, `image`) VALUES
	(1, 'USB Keyboard', 8, 1, 15, 0, '2019-01-22 12:24:35', '2019-01-22 12:24:35', NULL, 4, NULL, NULL, NULL, NULL, 2, 1, '17539384', NULL, NULL),
	(2, 'Bluetooth Keyboard', 8, 1, 10, 0, '2019-01-22 12:24:35', '2019-01-22 12:24:35', NULL, 1, NULL, NULL, NULL, NULL, 2, 1, '31180426', NULL, NULL),
	(3, 'Magic Mouse', 9, 1, 13, 0, '2019-01-22 12:24:35', '2019-01-22 12:24:35', NULL, 3, NULL, NULL, NULL, NULL, 2, 1, '9579574', NULL, NULL),
	(4, 'Sculpt Comfort Mouse', 9, 1, 13, 0, '2019-01-22 12:24:35', '2019-01-22 12:24:35', NULL, 4, NULL, NULL, NULL, NULL, 2, 2, '36404919', NULL, NULL),
	(5, 'Junction box', 18, 59, 10, 0, '2019-01-31 09:35:04', '2019-01-31 09:35:04', NULL, 3, '2019-01-31', 500.00, '565', 1, 2, 1, '33', NULL, NULL),
	(6, 'Mouse Pad', 17, 59, 5, 0, '2019-01-31 12:51:35', '2019-02-05 09:09:34', NULL, 4, '2019-01-01', 400.00, 'ORDER-001', 1, 1, 3, 'DEL-001', NULL, NULL);
...
-- Dumping data for table asset_mgmt.action_logs: ~82 rows (approximately)
...
-- Dumping data for table asset_mgmt.assets: ~3 rows (approximately)
/*!40000 ALTER TABLE `assets` DISABLE KEYS */;
REPLACE INTO `assets` (`id`, `name`, `asset_tag`, `model_id`, `serial`, `purchase_date`, `purchase_cost`, `order_number`, `assigned_to`, `notes`, `image`, `user_id`, `created_at`, `updated_at`, `physical`, `deleted_at`, `status_id`, `archived`, `warranty_months`, `depreciate`, `supplier_id`, `location_id`, `costcentre_id`, `requestable`, `rtd_location_id`, `accepted`, `last_checkout`, `expected_checkin`, `company_id`, `checkin_counter`, `checkout_counter`, `requests_counter`, `assigned_type`, `_snipeit_re_contextualized_secondary_collaboration_1`, `_snipeit_robust_neutral_standardization_2`, `_snipeit_managed_client_server_core_3`, `_snipeit_organized_grid_enabled_intranet_4`, `_snipeit_depreciation_rates_5`, `next_audit_date`) VALUES
	(1, 'Desktop', '0001', 22, 'S001', '2019-01-30', 4500.00, '153', 59, '', 'DSkH6jTzAsHFHo3QPnUMSpYtx.jpeg', 59, '2019-01-31 11:46:05', '2019-02-05 09:44:11', 1, NULL, 1, 0, 12, 0, 1, NULL, 4, 1, 4, NULL, '2019-02-01 00:00:00', '2019-02-20', 1, 0, 0, 0, 'App\\Models\\User', NULL, NULL, NULL, NULL, NULL, NULL),
	(2, 'dsf', '00002', 23, '', '2017-11-28', 15000.00, '', NULL, '', 'dYy6fwFzawQj4GZyeezlqc7lA.jpeg', 59, '2019-01-31 12:33:27', '2019-02-08 13:28:02', 1, NULL, 3, 0, 12, 0, 1, 4, 4, 1, 4, NULL, NULL, NULL, 1, 2, 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL),
	(3, 'MacBook Pro', '00001', 1, 'Mac001', '2019-02-19', 150000.00, '#ORDER02', 59, '2.3GHz quad‑core 8th‑generation Intel Core i5 processor, Turbo Boost up to 3.8GHz', 'eSvwmlp8AF7EV1HZxGqhD8IWF.jpeg', 1, '2019-02-11 11:56:37', '2019-02-11 11:58:14', 1, NULL, 1, 0, 12, 0, 1, 4, 4, 1, 4, 'pending', '2019-02-11 11:56:37', NULL, 1, 0, 1, 0, 'App\\Models\\User', NULL, NULL, NULL, NULL, NULL, NULL);
...
-- Dumping data for table asset_mgmt.asset_maintenances: ~0 rows (approximately)
...
-- Dumping data for table asset_mgmt.categories: ~26 rows (approximately)
...
-- Dumping data for table asset_mgmt.companies: ~0 rows (approximately)
...
-- Dumping data for table asset_mgmt.costcentres: ~3 rows (approximately)
...
-- Dumping data for table asset_mgmt.departments: ~0 rows (approximately)
...
-- Dumping data for table asset_mgmt.electronics: ~2 rows (approximately)
/*!40000 ALTER TABLE `electronics` DISABLE KEYS */;
REPLACE INTO `electronics` (`id`, `name`, `category_id`, `user_id`, `qty`, `requestable`, `created_at`, `updated_at`, `deleted_at`, `location_id`, `purchase_date`, `purchase_cost`, `order_number`, `company_id`, `min_amt`, `manufacturer_id`, `supplier_id`, `model_number`, `image`) VALUES
	(1, 'Phone', 23, 1, 1, 0, '2019-02-04 07:26:42', '2019-02-05 09:17:52', NULL, 4, '2016-02-02', 50000.00, 'O-001', 1, 1, 13, 1, 'SPA525G', 'electronics-eyyJWgYbVHmwqwrjd2.jpg'),
	(2, 'Printers', 24, 1, 10, 0, '2019-02-04 12:51:11', '2019-02-08 12:59:50', NULL, 4, '2016-03-23', 15550.00, '123456', 1, 1, 5, 1, 'Laser jet pro MFP M126nw', NULL);
...
REPLACE INTO `electronics_users` (`id`, `user_id`, `electronics_id`, `assigned_to`, `created_at`, `updated_at`) VALUES
	...
	(5, 1, 1, 59, '2019-02-05 07:41:43', NULL),
...
-- Dumping data for table asset_mgmt.furnitures: ~0 rows (approximately)
/*!40000 ALTER TABLE `furnitures` DISABLE KEYS */;
REPLACE INTO `furnitures` (`id`, `name`, `category_id`, `user_id`, `qty`, `requestable`, `created_at`, `updated_at`, `deleted_at`, `location_id`, `purchase_date`, `purchase_cost`, `order_number`, `company_id`, `min_amt`, `manufacturer_id`, `model_number`, `supplier_id`, `image`) VALUES
	(7, 'Tables', 25, 1, 7, 0, '2019-02-05 13:28:43', '2019-02-05 13:28:43', NULL, 4, '2019-02-14', 500.00, '', 1, NULL, NULL, '', 1, NULL);
...
-- Dumping data for table asset_mgmt.furnitures_users: ~0 rows (approximately)
...
-- Dumping data for table asset_mgmt.imports: ~0 rows (approximately)
...
-- Dumping data for table asset_mgmt.infra_buildings: ~3 rows (approximately)
/*!40000 ALTER TABLE `infra_buildings` DISABLE KEYS */;
REPLACE INTO `infra_buildings` (`id`, `name`, `stock_holder_code`, `category_id`, `company_id`, `user_id`, `requestable`, `created_at`, `updated_at`, `deleted_at`, `description`, `revenue_village`, `dimension`, `length`, `breadth`, `no_of_floor`, `year_of_acquisition`, `improvement`, `total_cost`, `purchase_date`, `life_of_assets`, `no_of_years_assets_use`, `remaining_life`, `rate_of_depreciation`, `currunt_use_of_building`, `remarks`, `image`) VALUES
	(1, 'Building', 'TTCI001', 31, 1, 1, 0, '2019-02-08 07:17:15', '2019-02-12 09:56:51', NULL, 'This is a TTCI residential BUIlding', 'jl', 'test', NULL, NULL, '180', 'hkj', 'yes', 555000.00, '2019-02-11', 'permenent', '10', '5', 13, 'use', 'test building', 'infrastructures-yN8Kl1V3PnQ8QW0fRR.jpg'),
	(2, 'Residential', 'TTCI002', 27, 1, 1, 0, '2019-02-08 07:24:38', '2019-02-08 07:28:32', '2019-02-08 07:28:32', 'this is TTCI building', '13', 'fgggh', NULL, NULL, NULL, '2', 'hgj', 5066.00, '2019-02-13', 'hjg', '0', 'ghfh', 0, 'gfh', NULL, 'infrastructures-aG4u5M1e0n6736Nrp9.jpg'),
	(3, 'Commercial ', 'COM22', 32, 1, 1, 0, '2019-02-11 10:04:53', '2019-02-12 13:00:04', NULL, 'This is a commercial description', '5', NULL, '5005', '1005', '30', '2', 'yes', 999999.99, '2019-02-27', '50', '1', '49', 85, 'Active', 'This is a commercial description', 'infrastructures-JRm97yprnRCSIaLcxe.jpg');
...
-- Dumping data for table asset_mgmt.license_seats: ~50 rows (approximately)
...
-- Dumping data for table asset_mgmt.locations: ~2 rows (approximately)
...
-- Dumping data for table asset_mgmt.manufacturers: ~13 rows (approximately)
...
-- Dumping data for table asset_mgmt.models: ~9 rows (approximately)
...
-- Dumping data for table asset_mgmt.status_labels: ~7 rows (approximately)
...
-- Dumping data for table asset_mgmt.suppliers: ~0 rows (approximately)
...
-- Dumping data for table asset_mgmt.users: ~3 rows (approximately)
