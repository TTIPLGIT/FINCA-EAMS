    ...
    public function transformCompany (Company $company = null)
    {
        if ($company) {
            ...
            $array = [
                ...
                "electronics_count" => (int) $company->electronics_count,
            ...
            $permissions_array['available_actions'] = [
                ...
                'delete' => (Gate::allows('delete', Company::class) && ($company->assets_count == 0) && ($company->accessories_count == 0) && ($company->electronics_count == 0) && ($company->consumables_count == 0) && ($company->components_count == 0) && ($company->users_count == 0)) ? true : false,
            ];
