    ...
    function polymorphicItemFormatter(value) {
        ...
        if ((value) && (value.type)) {
            ...
            if (value.type == 'asset') {
                ...
                item_destination = 'electronics';
                item_icon = 'fa-microchip';
            } else if (value.type == 'furnitures') {
                item_destination = 'furnitures';
                item_icon = 'fa-keyboard-o';
            } else if (value.type == 'buildings') {
                item_destination = 'buildings';
