...
Route::group(['prefix' => 'v1','namespace' => 'Api'], function () {
    ...
    Route::resource('furnitures', 'FurnituresController',
        [
            'names' =>
                [
                    'index' => 'api.furnitures.index',
                    'show' => 'api.furnitures.show',
                    'store' => 'api.furnitures.store',
                    'update' => 'api.furnitures.update',
                    'destroy' => 'api.furnitures.destroy'
                ],
            'except' => ['create', 'edit'],
            'parameters' => ['furniture' => 'furnitures_id']
        ]
    ); // Furnitures resource

     Route::group(['prefix' => 'furnitures'], function () {

        Route::get('{furnitures}/checkedout',
            [
                'as' => 'api.furnitures.checkedout',
                'uses' => 'FurnituresController@checkedout'
            ]
        );
    }); // Furnitures group
    Route::get('furnitures/view/{id}/users',
        [
            'as' => 'api.furnitures.showUsers',
            'uses' => 'FurnituresController@getDataView'
        ]
    );
 ...
 /*--- Electronics API ---*/
    ...
    Route::resource('electronics', 'ElectronicsController',
        [
            'names' =>
                [
                    'index' => 'api.electronics.index',
                    'show' => 'api.electronics.show',
                    'store' => 'api.electronics.store',
                    'update' => 'api.electronics.update',
                    'destroy' => 'api.electronics.destroy'
                ],
            'except' => ['create', 'edit'],
     ...
     Route::group(['prefix' => 'electronics'], function () {
        ...
        Route::get('{electronics}/checkedout',
            [
                'as' => 'api.electronics.checkedout',
                'uses' => 'ElectronicsController@checkedout'
            ]
        );
    }); // Electronics group
    Route::get('electronics/view/{id}/users',
        [
            'as' => 'api.electronics.showUsers',
            'uses' => 'ElectronicsController@getDataView'
        ]
    );
...
/*--- Buildings API ---*/
    ...
    Route::resource('buildings', 'BuildingsController',
        [
            ...
            'except' => ['create', 'edit'],
            'parameters' => ['buildings' => 'buildings_id']
        ]
    ); // Buildings resource
    Route::get('buildings/view/{id}/users',
        [
            'as' => 'api.buildings.showUsers',
            'uses' => 'BuildingsController@getDataView'
        ]
    );
    ...
    /*--- CostCentres API ---*/
    Route::group(['prefix' => 'costcentres'], function () {

        Route::get('list',
            [
                'as'=>'api.costcentres.list',
                'uses'=>'CostCentresController@getDatatable'
            ]
        );

        Route::get('selectlist',
            [
                'as' => 'api.costcentre.selectlist',
                'uses' => 'CostCentresController@selectlist'
            ]
        );
    }); // Suppliers group
    ...
    Route::resource('costcentres', 'CostCentresController',
        [
            'names' =>
                [
                    'index' => 'api.costcentres.index',
                    'show' => 'api.costcentres.show',
                    'store' => 'api.costcentres.store',
                    'update' => 'api.costcentres.update',
                    'destroy' => 'api.costcentres.destroy'
                ],
            'except' => ['create', 'edit'],
            'parameters' => ['costcentre' => 'costcentre_id']
        ]
    ); // Depreciations resource
