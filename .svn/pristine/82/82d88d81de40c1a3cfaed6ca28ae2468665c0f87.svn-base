...
class CategoriesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $allowed_columns = ['id', 'name','category_type', 'category_type','use_default_eula','eula_text', 'require_acceptance','checkin_email', 'assets_count', 'accessories_count','electronics_count', 'consumables_count', 'components_count','licenses_count', 'image'];

        $categories = Category::select(['id', 'created_at', 'updated_at', 'name','category_type','use_default_eula','eula_text', 'require_acceptance','checkin_email','image'])
            ->withCount('assets', 'accessories', 'electronics', 'consumables', 'components','licenses');
    ...
    public function destroy($id)
    {
        ...
        elseif ($category->electronics()->count() > 0) {
            return response()->json(Helper::formatStandardApiResponse('error', null,  trans('admin/categories/message.assoc_items', ['asset_type'=>'electronics'])));
