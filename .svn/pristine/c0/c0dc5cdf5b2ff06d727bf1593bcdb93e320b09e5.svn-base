...
class UsersTransformer
{
    ...
    public function transformUser (User $user)
    {
        $array = [
                ...
                'electronics_count' => (int) $user->electronics_count,
        ...
        $permissions_array['available_actions'] = [
            ...
            'delete' => (Gate::allows('delete', User::class) && ($user->deleted_at=='') && ($user->assets_count == 0) && ($user->licenses_count == 0)  && ($user->accessories_count == 0)  && ($user->electronics_count == 0)  && ($user->consumables_count == 0)) ? true : false,
