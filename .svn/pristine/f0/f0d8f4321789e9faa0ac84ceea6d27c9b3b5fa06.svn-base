...
class User extends SnipeModel implements AuthenticatableContract, CanResetPasswordContract
{
    ...
    /**
     * Get electronics assigned to this user
     */
    public function electronics()
    {
        return $this->belongsToMany('\App\Models\Electronics', 'electronics_users', 'assigned_to', 'electronics_id')->withPivot('id')->withTrashed();
    }
    ...
    {
        return $this->belongsToMany('\App\Models\Buildings', 'buildings_users', 'assigned_to', 'buildings_id')->withPivot('id')->withTrashed();
    }
