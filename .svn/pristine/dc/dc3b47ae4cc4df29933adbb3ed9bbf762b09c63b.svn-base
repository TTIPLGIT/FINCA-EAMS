...
class Category extends SnipeModel
{
    ...
    */
    public $rules = array(
        ...
        'category_type'   => 'required|in:asset,accessory,consumable,component,electronics,furnitures,buildings,license',
    );
    ...
    */
    ...
    {
        return $this->hasMany('\App\Models\Electronics');
    }

    public function furnitures()
    {
        return $this->hasMany('\App\Models\Furnitures');
    }

    public function buildings()
    {
        return $this->hasMany('\App\Models\Buildings');
    }
