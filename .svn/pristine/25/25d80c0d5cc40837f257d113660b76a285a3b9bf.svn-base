...
return array(
    'about_electronics_title' 			=> 'Σχετικά με τα αξεσουάρ',
    'about_electronics_text'  			=> 'Τα αξεσουάρ είναι οτιδήποτε εκδίδετε στους χρήστες αλλά δεν έχουν αύξοντα αριθμό (ή δεν σας ενδιαφέρει να τα εντοπίζετε μοναδικά). Για παράδειγμα, ποντίκια υπολογιστή ή πληκτρολόγια.',
    'electronics_category' 				=> 'Κατηγορία αξεσουάρ',
    'electronics_name'  					=> 'Όνομα ανταλλακτικού',
