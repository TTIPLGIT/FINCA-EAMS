...
Route::group(['middleware' => 'auth','prefix' => 'modals'], function () {
    ...
    Route::get('costcentres',['as' => 'modal.costcentres','uses' => 'ModalController@costcentres']);
...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('reports/furnitures', [ 'as' => 'reports/furnitures', 'uses' => 'ReportsController@getFurnituresReport' ]);
    Route::get(
        'reports/export/furnitures',
        [ 'as' => 'reports/export/furnitures', 'uses' => 'ReportsController@exportFurnituresReport' ]
    );

    Route::get('reports/electronics', [ 'as' => 'reports/electronics', 'uses' => 'ReportsController@getElectronicsReport' ]);
    Route::get(
        'reports/export/electronics',
        [ 'as' => 'reports/export/electronics', 'uses' => 'ReportsController@exportElectronicsReport' ]
    );
