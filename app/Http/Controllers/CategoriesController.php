    ...
    public function destroy($categoryId)
    {
        ...
        if ($category->has_models() > 0) {
            return redirect()->route('categories.index')->with('error', trans('admin/categories/message.assoc_items', ['asset_type'=>'model']));
                ...
                return redirect()->route('electronics.index')->with('error', trans('admin/categories/message.assoc_items', ['asset_type'=>'electronics']));
            } elseif ($category->infrastructures()->count() > 0) {
                return redirect()->route('infrastructures.index')->with('error', trans('admin/categories/message.assoc_items', ['asset_type'=>'infrastructures']));
    ...
    public function show($id)
    {
        ...
        if ($category = Category::find($id)) {
            ...
            if ($category->category_type=='asset') {
                ...
                $category_type_route = 'electronics';
            } elseif ($category->category_type=='buildings') {
                $category_type = 'buildings';
                $category_type_route = 'buildings';
            }
             else {
